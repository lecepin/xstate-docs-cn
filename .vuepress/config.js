      ...
      '/zh/': {
        ...
        sidebar: [
          ...
          },
          {
            ...
            children: [
              '/zh/tutorials/reddit',
              {
                title: '7GUIs',
                children: [
                  '/zh/tutorials/7guis/counter',
                  '/zh/tutorials/7guis/temperature',
                  '/zh/tutorials/7guis/flight',
                  '/zh/tutorials/7guis/timer'
                ]
              }
            ]
          },
          ...
          },
          {
            title: '包',
            children: [
              '/zh/packages/xstate-react/',
              '/zh/packages/xstate-vue/',
              '/zh/packages/xstate-graph/',
              '/zh/packages/xstate-fsm/',
              '/zh/packages/xstate-test/',
              '/zh/packages/xstate-immer/',
              '/zh/packages/xstate-inspect/',
              '/zh/packages/xstate-svelte/'
            ]
          },
          {
            title: '模式',
            children: ['/zh/patterns/sequence']
          },
          {
            title: '示例',
            children: [
              '/zh/examples/counter',
              '/zh/examples/todomvc',
              '/zh/examples/calculator',
              '/zh/examples/covid-tracker'
            ]
          },
          {
            title: '新闻和有用地址',
